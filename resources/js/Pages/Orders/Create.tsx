...
export default function CreateOrder({ products, customers }: OrdersProps) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">CreateOrder</h2>}
        >
            ...
            <div className="py-3">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">オーダー登録</div>
                    </div>
                </div>
