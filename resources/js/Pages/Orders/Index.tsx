            ...
            <div className="py-3">
                ...
                <div className="m-3 max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="mt-3 mb-3 ml-3 flex">
                        ...
                        >
                            <i className="fa-solid fa-plus-circle"></i> オーダー登録
                        </Link>
                    ...
                    <table className="table-auto border border-gray-400 w-100 m-3">
                        ...
                        {orders.data.map((order) => {
                            return (
                                ...
                                <td className="border border-gray-400 px-2 py-2 text-center">{order.product2.tax}%</td>
                                ...
                                <td className="border border-gray-400 px-2 py-2 text-center">{order.product3.tax}%</td>
