...
export default function EditProduct({ product }: ProductProps) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">EditProduct</h2>}
        >
            ...
            <div className="py-3">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">商品更新</div>
                    </div>
                </div>
...
function patch(arg0: string, arg1: { onSuccess: () => void; }) {
